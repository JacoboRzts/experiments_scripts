#!/usr/bin/env python3
"""
f1_b2_mininet.py — Prueba B2: 4 pares full‑mesh, 3 leafs activos
Ejecutar: sudo python3 f1_b2_mininet.py [--topology sl] [--dry-run]
"""
...
def run_experiment(topology, dry_run):
    ...
    print(f"\n{'='*65}")
    print(f"  F1-B2 (Mininet) | Topología: {topology.upper()}")
    ...
    try:
        ...
        print(f"\n{'='*65}")
        print(f"  RESUMEN F1-B2 -- {topology.upper()} (Mininet)")
